...
43 casos. Requieren `argos-contracts-scenarios` como hermano o `ARGOS_CONTRACTS_PATH` (ver `../docs/development.md`) — se saltan automáticamente si no lo encuentran.
